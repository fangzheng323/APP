...
@interface FZScanerCardViewController()
/// 名片字符串
...
@implementation FZScanerCardViewController {
...
- (void)viewDidLoad {
    ...
    [FZScanner qrImageWithString:self.cardName avatar:self.avatar completion:^(UIImage *image) {
